...
public class Watch {
    ...
    private Integer caseThicknessMM;
    ...
    @Column(name="fourth_image",columnDefinition="LONGBLOB")
    @Lob
    private byte[] fourthImage;

    @Column(name="fifth_image",columnDefinition="LONGBLOB")
    @Lob
    ...
    public Watch(BigDecimal price, Integer discount, String modelNumber, boolean trending, String brand,
            String collectionName, String brandCountry, String manufactureOrExported, String importedBy,
            String description, String watchGlassOrCrystal, Integer warranty, String waterResistance, String caseMaterial,
            String gender, String caseShape, String dialColor, String dialType, Integer caseSizeMM, Integer caseThicknessMM,
            String strapColor, String strapMaterial, Integer strapWidthMM, String strapType, String careInstruction,
    ...
    public Integer getCaseThicknessMM() {
        return caseThicknessMM;
    }

    public void setCaseThicknessMM(Integer caseThicknessMM) {
        this.caseThicknessMM = caseThicknessMM;
    }
    ...
    public Integer getStrapWidthMM() {
        return strapWidthMM;
    }

    public void setStrapWidthMM(Integer strapWidthMM) {
        this.strapWidthMM = strapWidthMM;
    }
