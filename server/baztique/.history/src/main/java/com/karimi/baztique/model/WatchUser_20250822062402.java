...
public class WatchUser {
    ...
    @OneToMany(mappedBy="owner", cascade=CascadeType.ALLALL, orphanRemoval=true)
    @Column(name="watches")
    ...
    public WatchUser(String email, String userName, String password, String phoneNumber, String firstName,
            String lastName, String officeAddress, String homeAddress, List<Watch> watches) {
        this.email = email;
    ...
    public String toString() {
        return "WatchUser [userId=" + userId + ", email=" + email + ", userName=" + userName + ", password=" + password
                ...
                + ", officeAddress=" + officeAddress + ", homeAddress=" + homeAddress + ", watches=" + watches + "]";
    }
