...
public class Watch {
    ...
    public Watch(BigDecimal price, int discount, String modelNumber, boolean trending, String brand,
            ...
            LocalDateTime createdAt, LocalDateTime lastUpdated, WatchUser watchUser) {
        this.price = price;
    ...
    public String toString() {
        return "Watch [id=" + id + ", price=" + price + ", discount=" + discount + ", modelNumber=" + modelNumber
                ...
                + ", createdAt=" + createdAt + ", lastUpdated=" + lastUpdated + ", watchUser=" + watchUser + "]";
    }
