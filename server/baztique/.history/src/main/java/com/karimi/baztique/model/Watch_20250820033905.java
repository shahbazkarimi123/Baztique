...
public class Watch {
    ...
    @Column(name = "manufacture_orexported")
    ...
    public Watch(long id, BigDecimal price, int discount, String modelNumber, boolean trending, String brand,
    ...
    public String getWaterResistance() {
        return waterResistadeleteQuerynce;
    }
