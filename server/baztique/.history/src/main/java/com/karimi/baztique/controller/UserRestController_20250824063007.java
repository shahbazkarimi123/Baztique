...
public class UserRestController {
    ...
    public WatchUser loginUserByUserNameAndPassword(@RequestBody String userName, @RequestBody String password) throws Exceptions{
        try {
            WatchUser theWatchUser = userService.getUserByUserName(userName);
        } catch (Exception e) {
            
        }
        
        if(theWatchUser == null){
