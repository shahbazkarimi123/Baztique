          ...
          <div className="bg-[#03045e]/20 h-full w-full rounded-2xl flex flex-col justify-evenly z-30">
            ...
            <div className="flex flex-col gap-10">
              <input
                ...
                className="bg-gray-300 w-[95%] md:w-[h-14 rounded-2xl px-2 placeholder-[#023e8a] 
            ...
            <div className="flex justify-evenly gap-1">
              <button className=" bg-gray-400 w-[45%] py-4 rounded-2xl
              shadow-lg shadow-gray-800 text-">Login</button>
