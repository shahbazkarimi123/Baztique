          ...
          <div className="bg-[#03045e]/20 h-full w-full rounded-2xl flex flex-col justify-evenly z-30">
            ...
            <div className="flex flex-col gap-10 bg-yellow-300">
              <input
                ...
                className="bg-gray-300 w-full h-10 rounded-2xl px-2 placeholder-[#023e8a] border-none outline-none focus:ring-0 shadow-gray-700 shadow-lg"
              ></input>
              <input
                type="text"
                placeholder="Password"
                className="bg-gray-300 w-full h-8 rounded-2xl px-2 placeholder-[#023e8a] border-none outline-none focus:ring-0 shadow-gray-700 shadow-lg"
              ></input>
            </div>
            <div className="flex justify-evenly gap-1  bg-green-300">
              <button className=" bg-gray-400 w-[45%] py-3">Login</button>

              <h3 className=" bg-gray-400 w-[45%] py-3 text-center">Signup</h3>
            </div>
          </div>
        </div>
