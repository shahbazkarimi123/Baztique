      ...
      <div className="relative w-screen h-screen bg-gray-100">
        ...
        <div className="absolute inset-0 rounded-full bg-[#00b4d8] w-[60%] h-[60%] m-auto z-20">
          <div className="bg-[#03045e]/20 h-full w-full rounded-[2.4rem] flex flex-col justify-evenly z-30">
            ...
            <div className="">
            <form onSubmit={handleSubmit} className="flex flex-col gap-7 md:gap-10 justify-center items-center">
              <input
                type="text"
                name="userName"
            ...
            <div className="flex justify-center">
              <h3
                className=" bg-gray-300 w-[45%] md:w-[20%] py-4 text-center rounded-2xl border-2 border-gray-200
