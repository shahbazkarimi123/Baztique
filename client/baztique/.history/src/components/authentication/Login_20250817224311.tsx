          ...
          <div className="bg-[#03045e]/20 h-full w-full rounded-2xl flex flex-col justify-evenly z-30">
            ...
            <div className="flex flex-col gap-10 items-center">
              <input
                ...
                border-3 border-gray-200 outline-gray-200 focus:ring-0 shadow-gray-800 shadow-lg text-blue-900 font-normal"
              ></input>
              <input
                type="text"
                placeholder="Password"
                className="bg-gray-300 w-[95%] md:w-[50%] h-14 rounded-2xl px-2 placeholder-[#023e8a] 
                border-3 border-gray-200 outline-gray-200 focus:ring-0 shadow-gray-800 shadow-lg text-blue-900"
              ></input>
            </div>
            <div className="flex justify-evenly">
              <button className=" bg-gray-300 w-[45%] md:w-[20%] py-4 rounded-2xl border-2 border-gray-200
              shadow-lg shadow-gray-800 text-blue-900 font-medium">Login</button>

              <h3 className=" bg-gray-300 w-[45%] md:w-[20%] py-4 text-center rounded-2xl border-gray-200
              shadow-gray-800 shadow-lg text-blue-900 font-medium">Signup</h3>
            </div>
          </div>
        </div>
