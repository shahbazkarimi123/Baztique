  ...
  return (
    <div className="main-content">
      <div className="relative w-screen h-screen bg-gray-100">
        <div className="absolute inset-0 bg-[#caf0f8] w-[100%] h-[100%] m-auto hover:bg-[#46e9e9]"></div>
        <div className="absolute inset-0 rounded-full bg-[#9ce6f5] w-[90%] h-[90%] m-auto hover:bg-[#a4cccc]"></div>
