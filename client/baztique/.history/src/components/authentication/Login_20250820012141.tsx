  ...
  return (
    <div className="main-content">
      <div className="relative w-screen h-screen bg-gray-100">
        <div className="absolute inset-0 bg-[#caf0f8] w-[100%] h-[100%] m-auto hover:bg-[#caf0f0]"></div>
        <div className="absolute inset-0 rounded-full bg-[rgb(156,230,245)] w-[90%] h-[90%] m-auto hover:bg-[#caf0f0]"></div>
