          ...
          <div className="bg-[#03045e]/20 h-full w-full rounded-2xl flex flex-col justify-start z-30">
            ...
            <div className="flex flex-col gap-5 pt-20">
              <input
                ...
                className="bg-[#023e8a] w-full h-8 rounded-2xl px-2 placeholder-[#ade8f4] border-none outline-none focus:ring-0"
              ></input>
              <input
                type="text"
                placeholder="User Name"
                className="bg-gray-300 w-full h-8 rounded-2xl px-2 placeholder-[#023e8a] border-none outline-none focus:ring-0 shadow-gray-700 shadow-[20px]"
              ></input>
            </div>
