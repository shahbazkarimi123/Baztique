    ...
    <div className="main-content">
      <div className="relative w-screen h-screen bg-gray-100">
        ...
        <div className="absolute inset-0 rounded-full bg-[#00b4d8] w-[60%] h-[60%] m-auto z-20">
          <div className="bg-[#03045e]/20 h-full w-full rounded-[2.3rem] flex flex-col justify-evenly z-30">
            <div>
              <h1 className="text-center font-bold text-4xl text-[#03045e] 
              [text-shadow:_3px_3px_3px_lightgray]">Login...</h1>
            </div>
            ...
            <div className="flex justify-evenly">
              ...
              <h3 className=" bg-gray-300 w-[45%] md:w-[20%] py-4 text-center rounded-2xl border-2 border-gray-200
