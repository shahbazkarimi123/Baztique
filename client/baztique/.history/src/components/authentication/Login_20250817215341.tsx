  ...
  return (
    <div className="main-content">
      <div className="relative w-screen h-screen bg-gray-100">
        ...
        <div className="absolute inset-0 rounded-full bg-[#00b4d8] w-[60%] h-[60%] m-auto">
            <div className="bg-[#03045e]/20 h-full w-full rounded-2xl flex flex-col items-center justify-center z-30">
