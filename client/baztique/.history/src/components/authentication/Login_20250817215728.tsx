    ...
    <div className="main-content">
      <div className="relative w-screen h-screen bg-gray-100">
        ...
        <div className="absolute inset-0 rounded-full bg-[#00b4d8] w-[60%] h-[60%] m-auto z-20">
            ...
            <input type="text" placeholder="User Name" className="bg-[#023e8a] w-full h-8 rounded-2xl px-2 placeholder-[#ade8f4] border-none outline-none focus:ring-0"></input><input type="text" placeholder="User Name" className="bg-[#023e8a] w-full h-8 rounded-2xl px-2 placeholder-[#ade8f4] border-none outline-none focus:ring-0"></input>
