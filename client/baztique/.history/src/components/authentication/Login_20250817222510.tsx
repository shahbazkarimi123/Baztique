    ...
    <div className="main-content">
      <div className="relative w-screen h-screen bg-gray-100">
        ...
        <div className="absolute inset-0 rounded-full bg-[#00b4d8] w-[60%] h-[60%] m-auto z-20">
          <div className="bg-[#03045e]/20 h-full w-full rounded-2xl flex flex-col justify-evenly z-30">
            <div>
              <h1 className="text-center">Login</h1>
            </div>
            <div className="flex flex-col gap-10 bg-yellow-300">
              <input
                type="text"
                placeholder="User Name"
                className="bg-gray-300 w-full h-14 rounded-2xl px-2 placeholder-[#023e8a] border-none outline-none focus:ring-0 shadow-gray-700 shadow-lg"
              ></input>
              <input
                type="text"
                placeholder="Password"
                className="bg-gray-300 w-full h-14 rounded-2xl px-2 placeholder-[#023e8a] 
                border-none outline-none focus:ring-0 shadow-gray-800 shadow-lg"
              ></input>
            </div>
            <div className="flex justify-evenly gap-1  bg-green-300">
              <button className=" bg-gray-400 w-[45%] py-4 rounded-2xl shadow-lg shadow-gray-800">Login</button>

              <h3 className=" bg-gray-400 w-[45%] py-4 text-center rounded-2xl shadow-gray-800 shadow-lg">Signup</h3>
            </div>
          </div>
        </div>
