...
function NaviBar() {
  ...
  return (
    ...
    >
      ...
      <div className={`fixed top-0 right-0 h-full w-64 bg-gray-800 shadow-lg z-50 transform transition-transform duration-300 ${open?"translate-0":"translate-x-full"}`}>
