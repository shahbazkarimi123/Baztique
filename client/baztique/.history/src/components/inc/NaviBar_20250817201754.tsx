...
function NaviBar() {
  ...
  return (
    ...
    >
      ...
      <div
  className={`fixed top-0 right-0 h-full w-48 sm:w-56 bg-blue-900 shadow-lg z-50 transform transition-transform duration-300 ${
...
>
      ...
      <nav className=" flex flex-col space-y-4 px-6">
        <h1 className="text-gray-200 font-bold text-2xl">Baztique</h1>
