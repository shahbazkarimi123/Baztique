function NaviBar(){
    return (
        ...
        ">
            ...
            <ul>
                <li className="text-gray-300 hover:text-white cursor-pointer text-2xl">Men</li>
            </ul>
            <ul>
                <li className="text-gray-300 hover:text-white cursor-pointer text-2xl">Women</li>
            </ul>
            <ul>
                <li className="text-gray-300 hover:text-white cursor-pointer text-2xl">Couple</li>
            </ul>
            <ul>
