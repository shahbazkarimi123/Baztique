...
function NaviBar() {
  ...
  return (
    ...
    >
      <div>
        <h1 className="text-gray-100 font-bold text-4xl pl-6 hover:cursor-pointer">
      ...
      <button className="sm:hidden text-gray-300 pr-4" onClick={() => setOpen(true)}>
        <Menu size={28} />
      </button>
      {open && (
        <div
      ...
      <div
  className={`fixed top-0 right-0 h-full w-48 sm:w-56 bg-gray-800 shadow-lg z-50 transform transition-transform duration-300 ${
