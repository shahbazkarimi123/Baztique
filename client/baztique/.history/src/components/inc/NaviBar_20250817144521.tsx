  ...
  return (
    ...
    >
      ...
      <nav className=" flex flex-col space-y-4 px-6">
        <a href="#" className="text-gray-300 hover:text-white text-lg">Men</a>
          <a href="#" className="text-gray-300 hover:text-white text-lg">Women</a>
          <a href="#" className="text-gray-300 hover:text-white text-lg">Couple</a>
      </nav>
    </div>
  );
}
