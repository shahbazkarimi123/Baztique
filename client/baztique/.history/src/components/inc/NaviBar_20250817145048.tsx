...
function NaviBar() {
  ...
  return (
    ...
    >
      ...
      <button className="sm:hidden text-gray-300" onClick={() => setOpen(true)}>
        <Menu size={28} />
      </button>
      {open && (
        <div
      ...
      <div className={`fixed top-0 right-0 h-full w-64 bg-gray-800 shadow-lg z-50 transform transition-transform duration-300 ${open?"translate-0":"translate-x-full"}`}></div>
