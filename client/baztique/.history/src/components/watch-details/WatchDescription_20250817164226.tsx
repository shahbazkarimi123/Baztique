    ...
    <div className="main-content bg-gray-200">
      ...
      <div className="md:flex text-gray-500 font-light">
        <div className="w-1/2 pl-[5%]">
          ...
          <h3><span>Movement</span>: Quartz</h2>
          <h3><span>Warranty Time Period</span>: 24 Month</h2>
          <h3><span>Water Resistance</span>: 30 mm</h2>
          <h3><span>Case Material</span>: Stainless Steel</h2>
          <h3><span>Gender</span>: Men</h2>
          </div>
        </div>
