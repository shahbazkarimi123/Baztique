    ...
    <div className="main-content bg-white">
      <div className="flex-col md:columns-2">
        ...
        <div className="flex justify-center">
          <div className="pt-6">
            <div className="flex">
            <h1 className="font-bold text-[20px] sm:text-center md:text-start">
              CALVIN KLEIN
            </h1>
              <h1 className="size-[50%] text-center text-[10px] border-1 text-blue-900 border-blue-900 rounded-full">
                TRENDING
              </h1>
            </div>
