...
function WatchDescription() {
  ...
  return (
    <div className="main-content bg-white">
      ...
      <div className="md:flex text-gray-500 md:text-left font-light text-[14px] md:text-[16px]">
        <div className="md:w-1/2 px-10 md:px-[5%]">
          <h2 className="uppercase md:capitalize text-gray-700 text-[18px]">Description</h2>
          <p className="">
        ...
        <div className="pl-10 md:px-[5%] md:w-1/2 space-y-0">
          ...
          <div className="flex justify-between w-full">
            <div className="pr-1">
              <h2 className="uppercase md:capitalize text-gray-700 text-[18px] pt-5">Dial & Case</h2>
              <h3>
            ...
            <div className="pr-2">
              <h2 className="uppercase md:capitalize text-gray-700 text-[18px] pt-5">Strap</h2>
              <h3>
              ...
              <h3>
                <span className="text-gray-800 font-semilightt">Strap Type</span>: Strap
              </h3>
            </div>
          </div>
        </div>
