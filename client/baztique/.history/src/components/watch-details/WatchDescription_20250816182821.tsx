  ...
  return (
    <div className="main-content bg-gray-200">
      <div className="flex-col md:columns-2">
        ...
        <div className="flex justify-center">
          <div className="pt-6">
            <h1 className="font-semibold text-[22px] sm:text-center md:text-start">
              CALVIN KLEIN
            </h1>
            <h1 className="text-black text-[18px]">Men | Sport Multi-Functional</h1>
            <h1 className="text-gray-500 text-[15px]">SKB 2325343</h1>
            <h1 className="text-black text-[18px]">19,500</h1>
            <div>
              <h1 className="size-[57%] text-center border-1 text-blue-900 border-blue-90000 rounded-full">
                TRENDING
              </h1>
            </div>
            <div className="mt-10">
