      ...
      <div className="md:flex text-gray-500 md:text-left font-light text-[15px] md:text-[16px]">
        ...
        <div className="pl-10 md:px-[5%] w-1/2 py-8 space-y-1">
          ...
          <h2 className="text-gray-700 text-xl pt-5">DIAL & CASE</h2>
              ...
              <h3>
                <span className="text-gray-800">Dial Colour</span>: Blac  k
                Multi Function
              </h3> 
              <h3>
              ...
              <h3>
                <span className="text-gray-800">Case Thickness [mm]</span>: 10 mm
              </h3>
            </div>
            <div>
          ...
          <h2 className="text-gray-700 text-xl pt-5">STRAP</h2>
              ...
              <h3>
                <span className="text-gray-800">Strap Material</span>: Stainless Steel
                Multi Function
              </h3>
              <h3>
