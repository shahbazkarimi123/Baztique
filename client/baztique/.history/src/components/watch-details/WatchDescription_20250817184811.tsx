...
function WatchDescription() {
  ...
  return (
    <div className="main-content bg-gray-200">
      ...
      <div className="md:flex text-gray-500 md:text-left font-light text-[15px] md:text-[16px]">
        <div className="md:w-1/2 pl-10 md:px-[5%]">
          <h2 className="text-gray-700 text-[18px]">Description</h2>
          <p className="">
        ...
        <div className="pl-10 md:px-[5%] md:w-1/2 py-8 space-y-1">
          <h3>
          ...
          <div className="flex justify-between w-full bg-amber-300 pl-5">
            <div className="">
              ...
              <h3>
                <span className="text-gray-800">Dial Colour</span>: Black Multi
                Function
              </h3>
              <h3>
                <span className="text-gray-800">Dial Type</span>: Analog
              </h3>
              <h3>
                <span className="text-gray-800">Case Size [mm]</span>: 44 MM
              </h3>
              <h3>
                <span className="text-gray-800">Case Thickness [mm]</span>: 10
                mm
              </h3>
            </div>
            <div className="">
              <h2 className="text-gray-700 text-xl pt-5">STRAP</h2>
              <h3>
                <span className="text-gray-800">Strap Color</span>: Rose Gold
              </h3>
              <h3>
                <span className="text-gray-800">Strap Material</span>: Stainless
                Steel Multi Function
              </h3>
              <h3>
                <span className="text-gray-800">Strap Width [mm]</span>: 22 MM
              </h3>
              <h3>
                <span className="text-gray-800">Strap Type</span>: Strap
              </h3>
            </div>
          </div>
        </div>
