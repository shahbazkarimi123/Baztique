...
function WatchDescription() {
  ...
  return (
    <div className="main-content bg-gray-200">
      ...
      <div className="md:flex text-gray-500 font-light">
        <div className="w-1/2 pl-[5%]">
          ...
          <h3 className=""><span className="text-gray-800">Watch Glass/Crystal</span>: Mineral Glass</h3>
          <h3><span className="text-gray-800">Movement</span>: Quartz</h2>
          <h3><span className="text-gray-800">Warranty Time Period</span>: 24 Month</h2>
          <h3><span className="text-gray-800">Water Resistance</span>: 30 mm</h2>
          <h3><span className="text-gray-800">Case Material</span>: Stainless Steel</h2>
          <h3><span className="text-gray-800">Gender</span>: Men</h2>
          </div>
        </div>
