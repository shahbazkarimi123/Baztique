    ...
    <div className="main-content bg-gray-200">
      ...
      <div className="md:flex text-gray-500 font-light">
        <div className="w-1/2 pl-[5%]">
          ...
          <h3><span class>Movement</span>: Quartz</h2>
          <h3><span class>Warranty Time Period</span>: 24 Month</h2>
          <h3><span class>Water Resistance</span>: 30 mm</h2>
          <h3><span class>Case Material</span>: Stainless Steel</h2>
          <h3><span class>Gender</span>: Men</h2>
          </div>
        </div>
