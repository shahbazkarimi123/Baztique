...
function PrivacyPolicy(){
    return (
        <div className="main-content px-20 pb-6">
            ...
            <p>We take appropriate technical and organizational measures to protect your personal information against unauthorized access, loss, or misuse. However, please understand that no method of data transmission or storage over the internet is 100% secure.</p>
