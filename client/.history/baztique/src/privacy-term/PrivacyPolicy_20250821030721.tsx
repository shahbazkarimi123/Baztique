...
function PrivacyPolicy(){
    return (
        <div className="main-content px-20 pb-6 bg-gray-200">
            ...
            <p className="pt-10">Welcome to [Your Website Name]! By using our website and purchasing products from us, you agree to the following Terms and Conditions. Please read them carefully before placing any order.</p>
            ...
            <p>We may update this Privacy Policy from time to time. Any changes will be reflected on this page with the updated effective date. We encourage you to review it periodically.</p>

            <hr className="my-10"></hr>

            {/* Contact Us */}
            <h2 className="text-2xl font-semibold">7. Contact Us</h2>
            <p className="pt-5">If you have any questions or concerns about this Privacy Policy or how we handle your information, you can reach us at:</p>
