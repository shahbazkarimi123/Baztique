...
function PrivacyPolicy(){
    return (
        <div className="main-content px-20 pb-6">
            ...
            <ul className="list-disc pl-5 space-y-3 pt-2">
                <li><sCreating and managing your user account.</li>
                <li><sProcessing and delivering your orders.</li>
                <li><sSending order updates, confirmations, or important notifications.</li>
                <li><sProviding customer support when needed.</li>
                <li><sImproving the functionality and user experience of our website.</li>
            </ul>
