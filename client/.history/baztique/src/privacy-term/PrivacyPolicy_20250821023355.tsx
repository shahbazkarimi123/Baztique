...
function PrivacyPolicy(){
    return (
        <div className="main-content px-20 pb-6">
            ...
            <ul className="list-disc pl-5 space-y-3 pt-2">
                <li><span>Service Providers:</span> With trusted third-party providers (e.g., payment gateways, delivery partners) who help us operate the website and fulfill your orders.</li>
                <li><span>Legal Requirements:</span> If required by law, regulation, or legal process.</li>
                <li><span>Business Transfers:</span> In case of a merger, acquisition, or sale of assets, your information may be transferred as part of the business assets.</li>
                <li><span></span>Providing customer support when needed.</li>
                <li><span></span>Improving the functionality and user experience of our website.</li>
            </ul>
