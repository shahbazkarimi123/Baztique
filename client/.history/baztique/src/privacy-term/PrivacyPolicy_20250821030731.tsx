...
function PrivacyPolicy(){
    return (
        <div className="main-content px-20 pb-6 bg-gray-200">
            ...
            <p className="pt-10">Welcome to ! By using our website and purchasing products from us, you agree to the following Terms and Conditions. Please read them carefully before placing any order.</p>
