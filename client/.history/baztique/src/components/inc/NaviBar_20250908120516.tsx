  ...
  return (
    ...
    >
      ...
      <div className="hidden sm:flex items-center pr-6 space-x-5">
        <Link
          to="/male-watches"
          className="text-gray-300 hover:text-white cursor-pointer text-[18px] font-semibold"
        >
          Men
        </Link>
        <Link
        ...
        <Link
          to={"#"}
          className="text-gray-300 hover:text-white cursor-pointer text-[18px] font-medium"
        >
          Couple
        </Link>
        {
          auth ? (<div onClick={signout} className="text-gray-300 hover:text-white cursor-pointer text-[18px]">logout</div>) : (<Link
          className="text-gray-300 hover:text-white cursor-pointer text-[18px]"
          to={`/watches/login`}
        >
          Login
        </Link>)
      ...
      <Link
        className="sm:hidden text-gray-300 hover:text-white cursor-pointer text-lg sm:text-2xl"
        to={`/watches/login`}
      >
        Login
      </Link>
