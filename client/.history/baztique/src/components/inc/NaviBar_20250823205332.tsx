  ...
  return (
    ...
    >
      ...
      <div className="hidden sm:flex items-center pr-6 space-x-5">
        ...
        <Link className="text-gray-300 hover:text-white cursor-pointer text-lg sm:text-2xl" to={`/watches/login`}>
          Login 
        
        </Link>
      </div>
      <Link className="sm:hidden text-gray-300 hover:text-white cursor-pointer text-lg sm:text-2xl" to={`/watches/login`}>
      ...
      >
        ...
        <nav className=" flex flex-col space-y-4 px-6">
          ...
          <Link to={"/male-watches"} className="text-gray-300 hover:text-white text-lg">
            Men
          </Link>
          <Link to={"/female-watches"} className="text-gray-300 hover:text-white text-lg">
            Women
          </Link>
