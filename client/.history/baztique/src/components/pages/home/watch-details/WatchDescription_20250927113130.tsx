...
import WatchSlider from "../slider/WatchSlider";
  ...
  return (
    <div className="main-content ">
        ...
        <div className="flex justify-center">
          <div className="pt-6">
            <div className="flex justify-between items-center w-full">
              <h1 className="uppercase font-semibold text-[24px] text-gray-800">{watch.brand}</h1>
              {watch.trending && (
                <h3 className=" text-center uppercase text-[10px] font-semibold px-2 py-1 text-white border-none 
                bg-red-500 rounded-full shadow shadow-gray-900 ml-2">
                  Trending
                </h3>
              )}
            </div>
      ...
      <div className="text-center py-8">
        ...
        <p className="pt-4 md:pt-16 font-semibold text-gray-800">
          <span className="text-[#845ec2]">MORE</span> INFORMATION
        </p>
      </div>
