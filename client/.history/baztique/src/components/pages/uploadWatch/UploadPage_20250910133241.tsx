    ...
    <div className="">
      <div>
        <form className="flex flex-col gap-5">
          ...
          <label>
            Imported By:
            <input type="text " value="" placeholder="Imported by" />
          </label>

          <label>
            Glass/Crystal:
            <input type="text " value="" placeholder="Enter Watch Glass Crystal" />
          </label>

          <label>
            Warranty:
            <input type="number" value="wa" placeholder="Warranty" />
          </label>
