  ...
  return (
    <div className="">
      <div className="max-w-md mx-auto p-6 bg-white shadow-xl rounded-2xl space-y-6">
        ...
        <label className="mb-1 text-sm font-semibold text-gray-700">Brand Name</label>
        <input
          type="text"
          placeholder="Enter brand name"
          className="px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"
        />
      </div>
          <label className="flex flex-col gap-2 text-sm font-medium text-gray-700">
            Brand Name:
            <input
            className="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-400 outline-none"
