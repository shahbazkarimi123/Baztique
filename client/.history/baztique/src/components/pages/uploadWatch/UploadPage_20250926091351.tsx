        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          <label className="flex flex-col gap-2 text-sm font-medium text-gray-700">
            ...
            >
              <div className="relative mt-1">
                <ListboxButton className="w-full rounded-lg border border-gray-300 px-3 py-2
                ...
                <ListboxOptions className="absolute w-full mt-1 bg-white border border-gray-300
          ...
          {watch.firstImage && (
            <img
              ...
              src={URL.createObjectURL(watch.firstImage)}
              alt="preview"
            />
          )}
          ...
          {watch.secondImage && (
            <img
              className="mt-2 h-28 w-28 rounded-lg object-cover shadow-md border border-gray-200"
              src={URL.createObjectURL(watch.secondImage)}
              alt="preview"
            />
          )}
          ...
          {watch.thirdImage && (
            <img
              className="mt-2 h-28 w-28 rounded-lg object-cover shadow-md border border-gray-200"
              src={URL.createObjectURL(watch.thirdImage)}
              alt="preview"
            />
          )}
          ...
          {watch.fourthImage && (
            <img
              className="mt-2 h-28 w-28 rounded-lg object-cover shadow-md border border-gray-200"
              src={URL.createObjectURL(watch.fourthImage)}
              alt="preview"
            />
          )}
          <label className="flex flex-col gap-2 text-sm font-medium text-gray-700">
          ...
          <button
            type="submit"
            className="border rounded-2xl bg-green-500 cursor-pointer px-4 py-2 text-white font-medium hover:bg-green-600 transition"
          >
            Upload
          </button>
        </form>
