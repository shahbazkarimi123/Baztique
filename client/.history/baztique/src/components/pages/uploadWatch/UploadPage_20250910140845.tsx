    ...
    <div className="">
      <div>
        <form className="flex flex-col gap-5">
          ...
          <label>
            Collection Name: <input type={watch.collectionName} value="collectionName" placeholder="Enter Enter Collection Name" />
          </label>
          ...
          <label>
            Warranty:
            <input type="number" name="wa" value={watch.warranty} placeholder="Warranty" />
          </label>
          ...
          <label>
            Dial Color:
            <input type="text " value="dialColor" placeholder="Enter Dial Color" />
          </label>

          <label>
            Dial Type:
            <input type="text" value="dialType" placeholder="Enter Dial Type" />
          </label>

          <label>
            Case Size (MM):
            <input type="text " value="caseSizeMM" placeholder="Enter Case Size MM" />
          </label>

          <label>
            Case Thickness MM:
            <input type="text " value="caseThicknessMM" placeholder="Enter Case Thickness MM" />
          </label>

          <label>
            Strap Color:
            <input type="text " value="strapColor" placeholder="Enter Strap Color" />
          </label>

          <label>
            Strap Material:
            <input type="text " value="strapMaterial" placeholder="Enter Strap Material" />
          </label>

          <label>
            Strap Width (MM):
            <input type="text " value="strapWidthMM" placeholder="Enter Strap Width MM" />
          </label>

          <label>
            Strap Type:
            <input type="text " value="Strap Type" placeholder="Enter Strap Type" />
          </label>

          <label>
            Care Instruction:
            <input type="text " value="Care Instruction" placeholder="Enter Care Instruction" />
          </label>

          <label>
            First Image:
            <input type="file" value="firstImage"/>
          </label>
