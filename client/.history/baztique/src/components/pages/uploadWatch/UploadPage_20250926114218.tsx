...
function UploadPage() {
  ...
  return (
    <div>
      <div className="relative z-10 max-w-md mx-auto p-6 bg-[#c4fcef] shadow-xl rounded-2xl space-y-6">
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="border rounded-2xl bg-[#00c9a7] cursor-pointer 
            px-4 py-2 text-white font-medium hover:bg-[#00c9b9] transition"
          >
            Save Watch
          </button>
        </form>
