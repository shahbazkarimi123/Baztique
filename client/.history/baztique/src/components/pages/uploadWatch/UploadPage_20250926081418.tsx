        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          <label className="flex flex-col gap-2 text-sm font-medium text-gray-700">
            ...
            <input
              ...
              file:rounded-lg file:border-0 file:bg-indigo-50 file:px-4 file:py-2 file:text-indigo-700 hover:file:bg-indigo-100 cursor-pointer"
              type="file"
              name="fourthImage"
              onChange={handleFileChange}
            />
          ...
          <button
            type="submit"
            className="border rounded-2xl bg-green-500 cursor:point"
          >
            Upload
          </button>
        </form>
