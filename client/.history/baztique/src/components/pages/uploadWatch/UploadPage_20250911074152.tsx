...
function UploadPage() {
  ...
  return (
    <div >
      <div className="relative max-w-md mx-auto p-6 bg-white shadow-xl rounded-2xl space-y-6">
        <form className="flex flex-col gap-5">
          ...
          <label className="flex flex-col gap-2 text-sm font-medium text-gray-700">
            Trending:
            <select
            className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-400 outline-none"
