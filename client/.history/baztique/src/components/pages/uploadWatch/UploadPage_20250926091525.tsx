        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          {watch.firstImage && (
            <img
              ...
              src={URL.revokeObjectURL(watch.firstImage)}
              alt="preview"
            />
          )}
          ...
          {watch.secondImage && (
            <img
              className="mt-2 h-28 w-28 rounded-lg object-cover shadow-md border border-gray-200"
              src={URL.revokeObjectURL(watch.secondImage)}
              alt="preview"
            />
          )}
          ...
          {watch.thirdImage && (
            <img
              className="mt-2 h-28 w-28 rounded-lg object-cover shadow-md border border-gray-200"
              src={URL.revokeObjectURL(watch.thirdImage)}
              alt="preview"
            />
          )}
          ...
          {watch.fourthImage && (
            <img
              className="mt-2 h-28 w-28 rounded-lg object-cover shadow-md border border-gray-200"
              src={URL.revokeObjectURL(watch.fourthImage)}
              alt="preview"
            />
          )}
          <label className="flex flex-col gap-2 text-sm font-medium text-gray-700">
