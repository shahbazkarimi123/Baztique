                ...
                <ListboxOptions className="absolute w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-50">
                  {trendOptions.map((option) => (
                    <ListboxOption
                      ...
                      value={option}
                      as="li"
                      className="list-none cursor-pointer select-none px-4 py-2 text-sm data-[headlessui-state=open]:bg-indigo-100 data-[headlessui-state=selected]:font-semibold font-normal"
                    >
                      {option ? "rue" : "False"}
                    </ListboxOption>
                  ))}
