  ...
  return (
    <div className="w-full bg-[#c4fcef]">
      ...
      <div className="flex flex-col justify-center gap-6  py-10 items-center">
        <div className="flex flex-col justify-center items-center md:w-[40%] w-[80%] border-4 border-[#845ec2] rounded-t-xl py-6 px-4 gap-7 h-[450px">
          <div className=" border-[#845ec2] border-2 py-4 rounded-t-xl">
