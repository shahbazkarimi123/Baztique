        ...
        <div className="flex flex-col md:w-[40%] w-[80%] border-2 border-gray-400 rounded-2xl py-6 px-4 gap-7 h-[450px">
          <div className="flex justify-center gap-3">
            ...
            <input className="bg-gray-300 rounded-[5px] py-1  text-center px-2 
             text-black font-medium shadow-[5px_5px_8px] shadow-black hover:shadow-lg" placeholder="Enter your number"/>
          </div>
          ...
          <div className="flex justify-center gap-3">
            ...
            <input className="bg-gray-300 rounded-[5px] py-1  text-center px-2
             text-black font-medium shadow-[5px_5px_8px] shadow-black hover:shadow-lg" placeholder="Enter your address"/>
          </div>
