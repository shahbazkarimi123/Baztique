  ...
  return (
    <div className="w-full">
      <div className="flex flex-col gap-6  py-10 items-center">
        <div className="flex flex-col md:w-[50%] border-2 border-gray-400 rounded-2xl py-6 px-4 gap-7 h-[450px">
        ...
        <div className=" flex flex-col justify-center md:w-[40%] w-full border-2 border-gray-600 rounded-2xl h-[300px] space-y-5 px-5">
