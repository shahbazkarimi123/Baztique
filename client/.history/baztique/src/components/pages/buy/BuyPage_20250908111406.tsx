  ...
  return (
    <div>
      <div className="flex justify-evenly py-10">
        <div className="flex flex-col justify-center items-center border-2 border-gray-400 rounded-2xl py-6">
            
            <p></p>Phone: <input className="bg-gray-300 w-[90%] rounded-[5px] h-8 border-none px-2
