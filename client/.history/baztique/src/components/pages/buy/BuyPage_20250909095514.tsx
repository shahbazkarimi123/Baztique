  ...
  return (
    <div className="w-full">
      <div className="flex flex-col gap-6  py-10 items-center">
        <div className="flex flex-col w-[60%] border-2 border-gray-400 rounded-2xl py-6 px-4 gap-7 h-[450px">
          ...
          <div className="flex gap-3">
            ...
            <p
              className="bg-gray-300 rounded-[5px] py-1  text-center px-2
             text-black font-medium shadow-[5px_5px_8px] shadow-black hover:shadow-lg"
            > Ab-330 amar puri nabi karim pahar ganj new delhi - 110055 jslkdfjalskfj iusflkasjf iujasf klsadjfoiuadsd fasdjfoisdaufasd fjdasoiufdsifj safjaslkjf asd dfuknsldk jfsajfoiasjf asfjalfkj asdufsdjf;odssdjfusd fkfj sfdosijf sdfijdsf;ds fidsfsdjfds f uadsfdsjd</p>
          </div>
        ...
        <div className=" flex flex-col justify-center w-[40%] border-2 border-gray-600 rounded-2xl h-[300px] space-y-5 px-5">
