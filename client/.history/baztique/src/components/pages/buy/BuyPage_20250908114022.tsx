      ...
      <div className="flex justify-evenly py-10">
        ...
        <div className="border-2 border-gray-600 rounded-2xl space-y-5 px-5">
            ...
            <div className="space-y-2">
                <h2 className="text-[10px] text-gray-">Subtotal:<span></span></h2>
                <h2 className="text-[10px] text-gray-">Taxes & GST: Included</h2>
                <h2 className="text-[10px] text-gray-">Total Amount: <span></span></h2>
            </div>
            <div className="flex flex-col items-center">
