  ...
  async function handleEmail(): Promise<void> {
    try{
      const mailBody = {to:API_EMAIL,subject:"Watch Order placed",message:
        `Watch id: ${watch!.id}, Watch Model: ${watch?.modelNumber}, Watch Brand: ${watch?.brand}, Phone no: ${phoneNumber}, Email id: ${email}, Address: ${address}`
      }
  ...
  return (
    <div className="w-full bg-[#c4fcef]">
      ...
      <h2 className="flex justify-center font-light text-[20px]">
        <span>{watch?.modelNumber}</span> | <span>{watch?.gender}</span>
      </h2>

      <div className="flex flex-col justify-center gap-6  py-10 items-center">
        <div className="flex flex-col justify-center md:w-[40%] w-[80%] border-4 border-[#845ec2] rounded-t-xl py-6 px-4 gap-7 h-[450px">
          <div className="flex flex-col justify-center items-center border-[#845ec2] border-2 py-4 rounded-t-xl">
            <p className="text-[16px] text-gray-700 font-semibold text-center">
              Phone No
            </p>
            <input className="bg-white rounded-[5px] py-1  text-center px-2 w-[95%]
          ...
          <div className="flex flex-col justify-center items-center border-2 border-[#845ec2] py-4">
            <p className="text-[16px] text-gray-700 font-semibold text-center">
              Address
            </p>
          ...
          <div className="flex flex-col justify-center items-center border-2 rounded-b-xl border-[#845ec2] py-4">
            <p className="text-[16px] text-gray-700 font-semibold text-center">
        ...
        <div className=" flex flex-col justify-center md:w-[40%] w-[80%] border-4
        border-[#845ec2] rounded-b-xl h-[300px] space-y-5 px-5">
