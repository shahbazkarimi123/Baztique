...
function BuyPage() {
  ...
  async function handleEmail(): Promise<void> {
    try{      const mailBody = {to:API_EMAIL,subject:"Watch Order placed",message:
      ...
      <div className="flex flex-col gap-6  py-10 items-center">
        <div className="flex flex-col md:w-[40%] w-[80%] border-2 border-gray-400 rounded-2xl py-6 px-4 gap-7 h-[450px">
          ...
          <div className="flex justify-between gap-3">
            ...
            <input onChange={(e)=>setAddress(e.target.value)} name='address' className="bg-gray-300 rounded-[5px] py-1  text-center px-2
