  ...
  return (
    <div className="w-full bg-[#c4fcef]">
      ...
      <div className="flex flex-col gap-6  py-10 items-center">
        <div className="flex flex-col md:w-[40%] w-[80%] border-4 border-[#845ec2] rounded-t-xl py-6 px-4 gap-7 h-[450px">
          <div className="flex justify-between gap-3 border-[#845ec2] border-2 p-3 rounded-t-xl">
            <p className="text-[16px] text-gray-700 font-semibold ">
              Phone No
            </p>
            <input className="bg-white rounded-[5px] py-1  text-center px-2 w-[90%]
          ...
          <div className="flex justify-between gap-3 border-2 border-[#845ec2] p-3">
            <p className="text-[16px] text-gray-700 font-semibold">
              Address
            </p>
            <input onChange={(e)=>setAddress(e.target.value)} 
            name='address' 
            className="bg-white rounded-[5px] py-1  text-center px-2 w-[90%]
          ...
          <div className="flex justify-between gap-3 border-2 rounded-b-xl border-[#845ec2] p-3">
            <p className="text-[16px] text-gray-700 font-semibold">
              Email Id <span className="font-light text-[15px]">(Optional)</span>
            </p>
            <input className="bg-white rounded-[5px] py-1  text-center px-2 w
             text-black font-medium shadow-[5px_5px_8px] shadow-black hover:shadow-lg"
             name="email"
