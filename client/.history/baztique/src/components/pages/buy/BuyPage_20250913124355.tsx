...
function BuyPage() {
  ...
  async function handleEmail(): Promise<void> {
    try{
      ...
      const response = "";
      const mailBody = {to:"shahbazkarimi007@gmail.com",subject:"Watch Order placed",message:
        `Watch id: ${watch!.id}, Watch Model: ${watch?.modelNumber}, Watch Brand: ${watch?.brand}, Phone no: ${phoneNumber}, Email id: ${emialId}, Address`
      }
