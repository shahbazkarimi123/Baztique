      ...
      <div className="flex flex-col gap-6  py-10 items-center">
        ...
        <div className=" flex flex-col justify-evenly w-[60%] border-2 border-gray-600 rounded-2xl h-[300px] space-y-5 px-5">
          ...
          <div className="space-y-2">
            <h2 className="flex justify-evenly text-[16px] text-gray-700 font-semibold">Subtotal:<span> 150</span>
            </h2>
            <h2 className="text-[16flex justify-evenly text-[16px] text-gray-700 font-semibold ">
              Taxes & GST: Included
            </h2>
            <h2 className="flex justify-evenly text-[16px] text-gray-700 font-semibold ">
              <span>Total Amount: </span><span className="text-end">150.59</span>
            </h2>
